...
FRAMEWORK_DIR = platform.get_package_dir("framework-arduinototemmaker")
...
env.Append(
    ...
    CPPPATH=[
       join(FRAMEWORK_DIR, "tools", "sdk", "include", "config"),
        ...
        join(FRAMEWORK_DIR, "tools", "sdk_totem", "include")
    ],
...
partitions_csv = env.BoardConfig().get("build.arduino.partitions", "default_8MB.csv")
