...
void loopPositionRead() {
  ...
  Serial.printf("Pos: %4d%%, Angle: %3d, Pulse: %4dus\n", 
    X4.servo.getPos(chA), 
    X4.servo.getAngle(chA), 
    X4.servo.getPulse(chA)
  );
  delay(100);
}
// Initialize program
...
void loop() {
  // Simple motor spin
  X4.servo.angle(chA, 0); // Spin motor to angle 0 (degree)
  delay(500);
  X4.servo.angle(chA, 90); // Spin motor to angle 90 (degree)
  delay(1000);
  // Inverted direction motor spin
  X4.servo.setInvert(chA, true); // Enable motor spin to opposite direction
  X4.servo.angle(chA, 0);
  delay(500);
  X4.servo.angle(chA, 90);
  delay(500);
  X4.servo.setInvert(chA, false); // Disable direction switching
  ...
  X4.servo.setSpeed(chA, 10); // Set motor spin speed to 10rpm
  X4.servo.angle(chA, 0);
  delay(2500);
  X4.servo.angle(chA, 90);
  delay(2500);
  X4.servo.setSpeed(chA, 0); // Set back to maximum motor speed
  ...
  X4.servo.angle(chA, 0, 2000); // Spin to position 0 in 2 seconds
  delay(2500);
  X4.servo.angle(chA, 90, 1000); // Spin to position 90 in 1 second
  delay(1500);
}